...
export default function Team() {
    return (
        <div className='team_wrapper'>
            ...
            <div className="bio">Brandon lives in Fayetteville, North Carolina. As a Professional Tattoo Artist, Brandon has a keen eye for design. Once he's graduated Lambda School, he intends to utilize his skills as a Full-Stack Developer to build new technology that could potentially benefit the world.</div>
            <br />
